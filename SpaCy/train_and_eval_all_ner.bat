...
python -m spacy train ./configs/config-ner.cfg --output ../../Models/Spacy_tagger/glove_5_200-ner --paths.train ./lumii-ner-spacy/ner-combined-train.spacy --paths.dev ./lumii-ner-spacy/ner-combined-dev.spacy --paths.vectors ..\..\Models\Spacy_tagger\glove_5_200_vectors
...
python -m spacy evaluate ..\..\Models\Spacy_tagger\glove_5_200-ner\model-best ./lumii-ner-spacy/ner-combined-test.spacy --output ../../datasets/NER/glove_5_200-ner.json --gold-preproc
